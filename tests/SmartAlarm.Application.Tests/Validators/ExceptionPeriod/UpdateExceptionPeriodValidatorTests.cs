...
public class UpdateExceptionPeriodValidatorTests
{
    private readonly Mock<IExceptionPeriodRepository> _repositoryMock;
    private readonly UpdateExceptionPeriodValidator _validator;
    private readonly Guid _testUserId = Guid.NewGuid();
    private readonly Guid _testPeriodId = Guid.NewGuid();

    public UpdateExceptionPeriodValidatorTests()
    {
        _repositoryMock = new Mock<IExceptionPeriodRepository>();
        _validator = new UpdateExceptionPeriodValidator(_repositoryMock.Object);
    }
