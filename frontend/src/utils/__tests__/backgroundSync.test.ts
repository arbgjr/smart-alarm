...
describe('BackgroundSync', () => {
  ...
  describe('Online Processing', () => {
    ...
    it('should keep failed operations in queue', async () => {
      const { alarmService } = await import('@/services/alarmService');
      alarmService.createAlarm.mockRejectedValue(new Error('Network error'));
      ...
      alarmService.createAlarm.mockResolvedValueOnce({ id: '1', name: 'Success Alarm' });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle network errors during sync', async () => {
      const { alarmService } = await import('@/services/alarmService');
      alarmService.createAlarm.mockRejectedValue(new Error('Network timeout'));
