...
public class CreateExceptionPeriodValidator : AbstractValidator<CreateExceptionPeriodCommand>
{
    private readonly IExceptionPeriodRepository _repository;

    public CreateExceptionPeriodValidator(IExceptionPeriodRepository repository)
    {
