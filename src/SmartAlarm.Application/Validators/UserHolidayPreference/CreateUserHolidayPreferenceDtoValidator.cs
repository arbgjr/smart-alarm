...
{
    /// <summary>
    /// Validator para CreateUserHolidayPreferenceDto.
    /// </summary>
    public class CreateUserHolidayPreferenceDtoValidator : AbstractValidator<CreateUserHolidayPreferenceDto>
    {
        public CreateUserHolidayPreferenceDtoValidator()
        {
            RuleFor(x => x.UserId)
                .NotEmpty()
